...
#include "include/DeterminismTest_C/SourceB.h"
#include "_sourceb.h"
...
void _sourcebreaction_function_0(void* instance_args) {
    ...
    #line 19 "/home/csm126/lf-test/DeterminismTest_C.lf"
    lf_set(out, 2);
    printf("[step 1] Source B fired at t=%lld\n", lf_time_logical());
#line 16 "/home/csm126/lf-test/src-gen/DeterminismTest_C/_sourceb.c"
}
